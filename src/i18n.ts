...
const EN: Dict = {
  ...
  playersInLobby: '{n} / 4 players',
  coopIntro: 'Play online with friends anywhere in the world! Create a lobby, share the code or invite link, get ready, and survive the siege together.',
  coopNote: 'If you fall, you spectate your friend until they defeat a boss — which revives you with 3s immortality!',
  nickSaved: 'Saved',
  changeNick: 'CHANGE',
  soloPlay: 'SOLO PLAY',
  myScore: 'MY SCORE',
  ...
  copied: 'Copied!',
  onlineBadge: 'ONLINE GLOBAL',
  startingIn: 'Starting in {n}…',
  youMustReady: 'All players must click Ready to begin',
  partnerUpgradeChoices: 'Teammate is choosing from:',
  rewardDrop: 'TEAM REWARD',
...
const RU: Dict = {
  ...
  playersInLobby: 'Игроков: {n} / 4',
  coopIntro: 'Играй онлайн с друзьями из любой точки мира! Создай лобби, поделись кодом или ссылкой, нажми «Готов» и выживайте вместе.',
  coopNote: 'Если погибнешь — наблюдаешь за другом, пока он не победит босса и не воскресит тебя с 3 секундами бессмертия!',
  nickSaved: 'Сохранено',
  changeNick: 'ИЗМЕНИТЬ',
  ...
  copied: 'Скопировано!',
  onlineBadge: 'ОНЛАЙН СЕТЬ',
  startingIn: 'Старт через {n}…',
  youMustReady: 'Все игроки должны нажать «Готов» для старта',
  partnerUpgradeChoices: 'Напарник выбирает из:',
  rewardDrop: 'НАГРАДА КОМАНДЕ',
