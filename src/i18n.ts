...
const EN: Dict = {
  ...
  close: '✕',
  // ---- multiplayer ----
  mp_title: 'CO-OP LOBBY',
  mp_newLobby: 'NEW LOBBY',
  mp_join: 'JOIN A FRIEND',
  mp_nickname: 'YOUR NICKNAME',
  mp_enterName: 'Enter a nickname to continue',
  mp_host: 'HOST',
  mp_you: 'YOU',
  mp_empty: 'EMPTY SLOT',
  mp_invite: '+ INVITE',
  ...
  mp_ready: 'READY',
  mp_unready: 'CANCEL',
  mp_notReady: 'NOT READY',
  mp_isReady: 'READY',
  mp_start: 'START',
  mp_startSolo: 'PLAY SOLO',
  mp_waitReady: 'Waiting for all players to ready up…',
  mp_leave: 'LEAVE',
  mp_back: 'BACK',
  mp_inviteCode: 'INVITE CODE — send this to your friend',
  mp_copy: 'COPY',
  mp_copied: 'COPIED!',
  mp_pasteAnswer: 'Paste your friend\'s JOIN CODE here',
  mp_connect: 'CONNECT',
  mp_offerHint: 'Paste the invite code your host sent you',
  mp_answerTitle: 'YOUR JOIN CODE — send it back to the host',
  mp_joinStep1: '1. Paste the host\'s invite code',
  mp_generate: 'GENERATE JOIN CODE',
  mp_joinStep2: '2. Send this JOIN CODE back to the host',
  mp_joinWait: 'Waiting for the host to accept…',
  mp_badCode: 'That code is invalid. Check and try again.',
  mp_lost: 'Connection lost.',
  mp_countdown: 'STARTING IN',
  mp_down: '{name} IS DOWN!',
  mp_bossReward: 'BOSS DOWN — 3s IMMORTALITY!',
  mp_spectating: 'SPECTATING {name}',
  mp_choosing: '{name} IS CHOOSING…',
  mp_waitPick: 'Waiting for {name} to pick an upgrade',
  mp_online: 'ONLINE CO-OP',
  mp_p2pNote: 'Peer-to-peer. Share codes to connect — no account needed.',
};
...
const RU: Dict = {
  ...
  close: '✕',
  // ---- multiplayer ----
  mp_title: 'КО-ОП ЛОББИ',
  mp_newLobby: 'НОВОЕ ЛОББИ',
  mp_join: 'ПРИСОЕДИНИТЬСЯ',
  mp_nickname: 'ВАШ НИКНЕЙМ',
  mp_enterName: 'Введите никнейм, чтобы продолжить',
  mp_host: 'ХОСТ',
  mp_you: 'ВЫ',
  mp_empty: 'ПУСТОЙ СЛОТ',
  mp_invite: '+ ПРИГЛАСИТЬ',
  mp_waiting: 'Ожидание…',
  mp_connecting: 'Подключение…',
  mp_ready: 'ГОТОВ',
  mp_unready: 'ОТМЕНА',
  mp_notReady: 'НЕ ГОТОВ',
  mp_isReady: 'ГОТОВ',
  mp_start: 'СТАРТ',
  mp_startSolo: 'ИГРАТЬ ОДНОМУ',
  mp_waitReady: 'Ждём готовности всех игроков…',
  mp_leave: 'ВЫЙТИ',
  mp_back: 'НАЗАД',
  mp_inviteCode: 'КОД ПРИГЛАШЕНИЯ — отправьте другу',
  mp_copy: 'КОПИРОВАТЬ',
  mp_copied: 'СКОПИРОВАНО!',
  mp_pasteAnswer: 'Вставьте КОД ПОДКЛЮЧЕНИЯ друга',
  mp_connect: 'ПОДКЛЮЧИТЬ',
  mp_offerHint: 'Вставьте код приглашения от хоста',
  mp_answerTitle: 'ВАШ КОД ПОДКЛЮЧЕНИЯ — отправьте его хосту',
  mp_joinStep1: '1. Вставьте код приглашения хоста',
  mp_generate: 'СОЗДАТЬ КОД ПОДКЛЮЧЕНИЯ',
  mp_joinStep2: '2. Отправьте этот КОД хосту',
  mp_joinWait: 'Ждём, пока хост примет вас…',
  mp_badCode: 'Неверный код. Проверьте и попробуйте снова.',
  mp_lost: 'Соединение потеряно.',
  mp_countdown: 'СТАРТ ЧЕРЕЗ',
  mp_down: '{name} ПОВЕРЖЕН!',
  mp_bossReward: 'БОСС ПАЛ — 3с БЕССМЕРТИЯ!',
  mp_spectating: 'НАБЛЮДЕНИЕ ЗА {name}',
  mp_choosing: '{name} ВЫБИРАЕТ…',
  mp_waitPick: 'Ждём, пока {name} выберет улучшение',
  mp_online: 'ОНЛАЙН КО-ОП',
  mp_p2pNote: 'P2P соединение. Обменяйтесь кодами — без аккаунтов.',
};
